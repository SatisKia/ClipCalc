...
CalcUI.prototype = {
 ...
 setMode : function( mode ){
  ...
  switch( this._mode ){
  case 0:
   this._param.setMode( 0x0012 );
   break;
  case 1:
   this._param.setMode( 0x0040 );
   break;
  case 2:
   this._param.setMode( 0x0041 );
   break;
  case 3:
   this._param.setMode( 0x0022 );
   break;
  case 4:
   switch( this._bitType ){
   case 0 : this._param.setMode( 0x0100 ); break;
   case 1: this._param.setMode( 0x0102 ); break;
   case 2: this._param.setMode( 0x0104 ); break;
   }
   break;
  case 5:
   switch( this._bitType ){
   case 0 : this._param.setMode( 0x0101 ); break;
   case 1: this._param.setMode( 0x0103 ); break;
   case 2: this._param.setMode( 0x0105 ); break;
   }
   break;
  case 6:
   switch( this._timeType ){
   case 0: this._param.setMode( 0x0080 ); break;
   case 1: this._param.setMode( 0x0081 ); break;
   case 2: this._param.setMode( 0x0082 ); break;
   case 3: this._param.setMode( 0x0083 ); break;
   }
   break;
  }
...
ConvUI.prototype = {
 ...
 getRadixString : function( value, radix, string ){
  ...
  string.set( (new _Token()).tokenString( param, 7, value ) );
  string.replace( "\\", "" );
  param.end();
 },
 getAngleString : function( value, oldType, newType, string ){
  ...
  string.set( (new _Token()).tokenString( param, 7, tmpValue ) );
  string.replace( "\\", "" );
  param.end();
 },
 ...
 getTimeValue : function( string, mode, value ){
  ...
  tmpString = string;
  switch( mode & 0x0FFF ){
  case 0x0080: tmpString += "h"; break;
  case 0x0081: tmpString += "m"; break;
  case 0x0082: tmpString += "s"; break;
  case 0x0083: tmpString += "f"; break;
  }
  param.setMode( mode );
 ...
 getValue : function( type, value ){
  ...
  case 1:
   ...
   switch( type ){
   case 0x01: this.getAngleValue( this._edit1, 1 , angType._val, value ); break;
   case 0x02: this.getAngleValue( this._edit2, 0 , angType._val, value ); break;
   case 0x04: this.getAngleValue( this._edit3, 2, angType._val, value ); break;
   }
   break;
  case 2:
   switch( type ){
   case 0x01: this.getTimeValue( this._edit1, 0x0080, value ); break;
   case 0x02: this.getTimeValue( this._edit2, 0x0081, value ); break;
   case 0x04: this.getTimeValue( this._edit3, 0x0082, value ); break;
   case 0x08: this.getTimeValue( this._edit4, 0x0083, value ); break;
   }
   break;
  }
 },
 update : function( value, type ){
  ...
  case 1:
   ...
   this._proc.getAngType( angType, updateFlag );
   if( (type & 0x01) != 0 ){
    this.getAngleString( value, angType._val, 1, tmpString );
    this._edit1 = tmpString.str();
   }
   if( (type & 0x02) != 0 ){
    this.getAngleString( value, angType._val, 0, tmpString );
    this._edit2 = tmpString.str();
   }
   if( (type & 0x04) != 0 ){
    this.getAngleString( value, angType._val, 2, tmpString );
    this._edit3 = tmpString.str();
   }
   this._edit4 = "";
   break;
  case 2:
   if( (type & 0x01) != 0 ){
    this.getTimeString( value, 0x0080, tmpString );
    this._edit1 = tmpString.str();
   }
   if( (type & 0x02) != 0 ){
    this.getTimeString( value, 0x0081, tmpString );
    this._edit2 = tmpString.str();
   }
   if( (type & 0x04) != 0 ){
    this.getTimeString( value, 0x0082, tmpString );
    this._edit3 = tmpString.str();
   }
   if( (type & 0x08) != 0 ){
    this.getTimeString( value, 0x0083, tmpString );
    this._edit4 = tmpString.str();
   }
   break;
  }
...
function assertProc( num, func ){
 ...
 if( englishFlag ) con[1].println( "Error " + intToString( 0x2001, 16, 4 ) + ":" + consoleBreak() + "Failed to assert." );
 else con[1].println( "エラー(" + intToString( 0x2001, 16, 4 ) + "):" + consoleBreak() + "アサートに失敗しました" );
...
function updateCalcRadioAngType(){
 ...
 document.getElementById( "calc_radio_deg" ).checked = (type._val == 1 );
 document.getElementById( "calc_radio_rad" ).checked = (type._val == 0 );
 document.getElementById( "calc_radio_grad" ).checked = (type._val == 2);
 convUI.update();
}
function doCalcDeg(){
 calcUI.setAngType( 1 );
